...
#include "map.hpp" // change from original: #include <colormap/map.hpp>
    ...
    const std::map<std::string, map<rgb>> palettes = {
          ...
          //////////////////////////////////////////////////////////////
        {
            ...
            map<rgb> {
                ...
                rgb{ 0x35, 0x65, 0xb4 },
                rgb{ 0x64, 0x9d, 0xd1 },
                rgb{ 0x91, 0xc3, 0xe2 }, //and the rest got darkened a bit
                rgb{ 0xb8, 0xd9, 0xc8 }, //this was converted to gray from almost-white
                rgb{ 0xff, 0xff, 0xa8 }, //this was darkened a bit
                rgb {0xfe, 0xe0, 0x90},
                rgb {0xfd, 0xae, 0x61},
                rgb {0xf4, 0x6d, 0x43},
                rgb {0xd7, 0x30, 0x27},
