 ...
 *
 * pnorm_both() is taken and adapted from R-4.0.2, originally licensed under
 * GPLv2, which is compatible with BlosSOM. We whole-heartedly thank the R
 * project for maintaining a quality library of mathematical function
 * implementations. Original licence and copyright follows:
 *
